...
Write a program that prints all the names defined by the compiled module https://github.com/holbertonschool/0x02.py/raw/master/hidden_4.pyc(hidden_4.pyc) (please download it locally).
